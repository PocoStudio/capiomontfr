...
const cguSections = [
  ...
  },
  {
    ...
    content: (
      <>
        ...
        <p>Les utilisateurs sont seuls responsables des contenus qu’ils publient sur les services.</p>
        <p>
          L’utilisation des services est réservée aux personnes âgées d’au moins <strong>15 ans</strong> 
          ou disposant de l’autorisation d’un représentant légal conformément à la législation en vigueur.
        </p>
        <p>
          Capiomont.fr se réserve le droit de modérer, supprimer ou signaler tout contenu jugé inapproprié 
          dans les chats ou autres espaces interactifs, sans préavis ni justification.
        </p>
        <p>
          Capiomont.fr se réserve également le droit de suspendre ou supprimer tout compte utilisateur 
          en cas de non-respect des présentes conditions.
        </p>
        <p>
          Les contenus manifestement illicites pourront être signalés aux autorités compétentes.
        </p>
        <p>
          Capiomont.fr se réserve une totale liberté de modération des contenus et des comptes utilisateurs, 
          incluant leur modification, suspension ou suppression, à tout moment et sans justification.
        </p>
      </>
    ),
  },
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          Capiomont.fr respecte la confidentialité des données personnelles de ses utilisateurs et met en place 
          des mesures de protection conformes au <strong>Règlement Général sur la Protection des Données (RGPD)</strong>.
        </p>

        <p>
          Les données susceptibles d’être enregistrées incluent, sans s’y limiter : le nom, l’adresse e-mail, 
          l’adresse IP, les informations de connexion chiffrées, les messages envoyés dans les chats, 
          ainsi que les données fournies volontairement par l’utilisateur lors de son inscription ou de son utilisation des services.
        </p>
        ...
        <ul className="list-disc list-inside pl-4">
          <li>Exécution du service (création de compte, accès aux fonctionnalités)</li>
          <li>Intérêt légitime (sécurité, prévention des abus)</li>
          <li>Consentement lorsque requis</li>
        </ul>
        <p>
          Les utilisateurs disposent d’un droit d’accès, de rectification et de suppression de leurs données personnelles. 
          Toute demande peut être effectuée en contactant notre support à l’adresse <strong>contact@capiomont.fr</strong>.
        </p>
      </>
    ),
  },
  {
    ...
    content: (
      <>
        <p>
          Nous utilisons des cookies strictement nécessaires au bon fonctionnement des services. 
          Ces cookies permettent d’assurer la navigation, la sécurité, ainsi que la personnalisation de l’expérience utilisateur.
        </p>

        <p>
          Les données collectées via les cookies peuvent inclure des informations sur les préférences de navigation, 
          les pages visitées et les interactions avec le site.
        </p>

        <p>
          Les cookies utilisés sur ce domaine et ses sous-domaines ont uniquement pour but d’assurer le bon fonctionnement 
          des services et d’améliorer votre expérience utilisateur. Ils ne sont pas utilisés à des fins commerciales.
        </p>

        <p>
          L’utilisateur peut configurer son navigateur pour refuser ou supprimer les cookies à tout moment.
        </p>
      </>
    ),
  },
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          Le contenu de Capiomont.fr et de ses sous-domaines (textes, images, logos, codes sources) 
        ...
        <p>
          L’utilisateur accorde à Capiomont.fr un droit non exclusif d’utilisation des contenus qu’il publie, 
          strictement nécessaire au fonctionnement des services.
        </p>
      </>
    ),
  },
  ...
  {
    id: 'cgu-14',
    title: 'XIV. Mentions Légales', 
    content: (
      <>
        <p><strong>Éditeur du site :</strong> Capiomont.fr</p>
        <p><strong>Responsable de la publication :</strong> Nathan Capiomont</p>
        <p><strong>Date de mise à jour :</strong> Mercredi 01 avril 2026</p>
        <p><strong>Hébergement :</strong> 
          Infrastructure principale sur NAS personnel (auto-hébergement), 
          nom de domaine et services associés via O2Switch, 
          déploiement frontend via GitHub Pages et O2Switch.
        </p>
  ...
  },
  {
    ...
    content: (
      <>
        ...
        <ul className="list-disc list-inside pl-4">
          <li><strong>Prestataires techniques :</strong> Hébergeur Synology NAS Personnel / O2Switch pour le stockage et la maintenance et O2Switch pour le domaine.</li>
